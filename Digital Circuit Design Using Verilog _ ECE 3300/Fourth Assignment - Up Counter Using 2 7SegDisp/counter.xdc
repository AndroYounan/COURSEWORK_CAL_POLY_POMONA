...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {mclk}]; //{CLK100MHZ}
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { pause }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
