...
## RGB LEDs
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { CO }]; #IO_L5P_T0_D06_14 Sch=led16_b
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { sel }]; #IO_L12P_T1_MRCC_14 Sch=btnl
